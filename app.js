...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Assuming you have a function to switch tabs, call initSkillBars when the Skills tab is activated
    // For demonstration, call it directly to animate bars on page load
    initSkillBars();

    // If you have tab switching logic, you'd call initSkillBars() similarly when the Skills tab is shown
});
